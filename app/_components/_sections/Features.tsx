        ...
        <section ref={featuresContainer} className="featuresContainer relative flex flex-col justify-center items-center w-full h-screen p-6 pt-24">
            <div className="flex flex-col w-full max-w-270 h-full">
                ...
                <div className="grid grid-flow-col grid-cols-6 grid-rows-4 gap-4 h-full w-full">
                    <FeatureCard additionalClass="scrollFade blur-[10px] opacity-0 row-span-4 col-span-2 bg-light-blue">
                        <h3>43%</h3>
                    ...
                    <FeatureCard additionalClass="scrollFade blur-[10px] opacity-0 row-span-2 col-span-2 bg-accent text-white">
                        <h3>18 hrs</h3>
                    ...
                    <FeatureCard additionalClass="scrollFade blur-[10px] opacity-0 row-span-2 col-span-4 bg-cover bg-[url(https://res.cloudinary.com/df9xjyhfb/image/upload/v1770350247/pexels-marcus-aurelius-6787761_og4odb.jpg)]">
                    ...
                    <FeatureCard additionalClass="scrollFade blur-[10px] opacity-0 row-span-2 col-span-2 bg-primary">
                        <h3>92%</h3>
