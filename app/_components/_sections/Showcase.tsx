...
export default function ShowcaseSection(){
	...
	return(
		<section ref={showcaseContainer} className="showcaseContainer flex w-full h-screen flex-col items-center justify-center gap-10 bg-accent p-6 lg:flex-row lg:gap-10 lg:p-[80px]">
			<div className="flex gap-8 w-full max-w-270 h-full">
				<div className="flex w-full flex-col items-start justify-between gap-8 lg:h-full lg:w-150">
					...
					<div className="h-60 scrollFade blur-[10px] w-full overflow-hidden rounded-[40px] lg:h-85">
						<img alt="" className="h-full w-full object-contain" src={showcasePhoto} />
					</div>
				</div>
				<div className="relative h-80 p-4 scrollFade blur-[10px] w-full overflow-hidden rounded-[40px] bg-light-blue lg:h-180 lg:w-250">
